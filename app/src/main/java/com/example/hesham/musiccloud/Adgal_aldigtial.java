...
public class Adgal_aldigtial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adgal_aldigtial);

        ///////////////////backword
        ImageView imageview2 = findViewById(R.id.imageView2);
        imageview2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(Adgal_aldigtial.this, Remi.class);
        ...
        imageview3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(Adgal_aldigtial.this, Secret_garden.class);
                startActivity(intent);
                mediaPlayer.pause();
                finish();
            }
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.adgalaldidital);
