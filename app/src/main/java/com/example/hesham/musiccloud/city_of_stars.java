...
public class city_of_stars extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.city_of_stars);

        ///////////////////backword
        ImageView imageview2 = findViewById(R.id.imageView2);
        imageview2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(city_of_stars.this, sun.class);
        ...
        imageview3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(city_of_stars.this, Dream.class);
                startActivity(intent);
                mediaPlayer.pause();
                finish();
            }
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.cityofstars);
