...
public class Bioshock_Burial_at_the_sea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bioshock_burial_at_the_sea);

        ///////////////////backword
        ImageView imageview2 = findViewById(R.id.imageView2);
        imageview2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(Bioshock_Burial_at_the_sea.this, Bioshock_infinite.class);
        ...
        imageview3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(Bioshock_Burial_at_the_sea.this, Bioshock.class);
                startActivity(intent);
                mediaPlayer.pause();
                finish();
            }
