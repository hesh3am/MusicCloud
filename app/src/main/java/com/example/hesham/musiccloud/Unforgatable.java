...
public class Unforgatable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unforgatable);

        ///////////////////backword
        ImageView imageview2 = findViewById(R.id.imageView2);
        imageview2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(Unforgatable.this, La_via_en_rose.class);
        ...
        imageview3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(Unforgatable.this, What_awonderfull.class);
                startActivity(intent);
                mediaPlayer.pause();
                finish();
            }
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.unforgatable);
