...
public class La_via_en_rose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.la_via_an_rose);

        ///////////////////backword
        ImageView imageview2 = findViewById(R.id.imageView2);
        imageview2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(La_via_en_rose.this, What_awonderfull.class);
        ...
        imageview3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(La_via_en_rose.this, Unforgatable.class);
                startActivity(intent);
                mediaPlayer.pause();
                finish();
            }
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.lovoenrose);
